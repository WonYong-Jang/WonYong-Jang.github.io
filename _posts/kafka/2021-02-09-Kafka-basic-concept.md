...
<img width="700" src="/img/posts/kafka/스크린샷 2025-07-29 오후 3.30.09.png">   
...
> 여러 옵션에 의해 세그먼트 파일 관리에 대한 설정 변경이 가능하며 .log 의 파일로 남게 된다.     
> 000000123.log 파일 이름일 경우 123 offset 부터 시작되는 파일이기 때문에 파일 이름으로 레코드를 찾을 수 있다.     
...
<img src="/img/posts/data-engineering/스크린샷 2025-08-11 오후 4.50.01.png">
...
`따라서, 브로커 개수가 3대 라면 Replication 갯수는 3개가 최대이다.`     
