...
[DataFrame](https://wonyong-jang.github.io/spark/2021/05/01/Spark-DataFrame.html)에서 설명한 것처럼 Spark 엔진은 functional code를 파싱하지 않기 때문에 catalyst optimizer가 최적화 하지 않는다.   
하지만, Dataset을 이용하여 functional code를 사용했을 때, 
    RDD를 이용하여 코드를 작성하는 것보다는 빠른 성능을 보장 받을 수 있다.   
