...
subtitle: "데이터 웨어하우스(Data Warehouse)와 데이터레이크(Data Lake) 차이 / ETL 과 ELT"   
comments: true
...
> 고객의 민감한 정보나 금융 거래 데이터를 다룰 때 데이터가 정제되어야 할 비지니스 규칙이 명확하며, 모든 데이터가 일관된 상태로 
유지되어야 하는 경우 ETL이 적합하다.   
