...
`Reducer 는 상태를 업데이트를 관리하는 함수이며, 각 노드의 반환값은 해당 상태 키의 이전 값을 
덮어쓰기 저장을 한다.(기본 리듀서)`      

<img src="/img/posts/ai/2026-03-08/스크린샷 2026-03-08 오후 1.24.38.png" width=500 height=500>

`또한, 메시지 리스트 등에서 이전 상태에 새로운 값을 추가할때도 
사용 가능하며 이를 add 리듀서라고 부른다.`   

<img src="/img/posts/ai/2026-03-08/스크린샷 2026-03-08 오후 1.24.50.png" width=500 height=500>
